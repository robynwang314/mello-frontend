...
board.lists.forEach(function(list,index) {
  ...
  list.cards.forEach(function(card) {
    ...
    $addCardButton.textContent = card.text;
    $addCardButton.setAttribute('data-id', card.id);
    $addCardButton.addEventListener('click', handleCardEdit);

    $cardLi.appendChild($addCardButton);
